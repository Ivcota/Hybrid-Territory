  ...
  return (
    <>
      ...
      <div className='w-full'>
        ...
        <p className="mt-2 mx-auto font-OpenSans italic font-light text-center text-off-black/80 text-sm tracking-wide lg:w-1/2">
        ...
        <div className='w-2/3 border-b border-off-black mx-auto text-transparent'>-</div>
        <div className="mt-4">
