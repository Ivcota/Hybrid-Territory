...
const DncModal = ({  fn }: IProps) => {
  ...
  return (
    <>
      <Button variant='custom'  onClick={openModal} className='mb-4 font-medium border bg-none text-error hover:text-error/70 active:text-error/50 border-error hover:border-error/70 active:border-error/50 font-Roboto dark:text-error-dark dark:border-error-dark/80 dark:hover:text-error-dark'>
        Do Not Calls
      </Button>
