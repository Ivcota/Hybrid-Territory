    ...
    <>
      ...
      >
        ...
        <main>
                    ...
                    {currentUser?.roles === 'admin' && (
                      <>
                        <div className="w-full border-b-2 border-dark-blue dark:border-dark-blue-dark">
                          <h3 className="mt-5 text-xl font-semibold tracking-wide font-Roboto text-off-black dark:text-off-white-dark">
                            Admin Settings
                          </h3>
                        </div>
                        <NavLink
          ...
          <div className="max-w-4xl px-4 pt-5 mx-auto duration-300 bg-white dark:bg-off-black">
            {children}
          </div>
        </main>
      </Provider>
