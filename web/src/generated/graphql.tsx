...
export function useMyTerritoriesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MyTerritoriesQuery, MyTerritoriesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<MyTerritoriesQuery, MyTerritoriesQueryVariables>(MyTerritoriesDocument, options);
        }
